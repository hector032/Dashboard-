...
class Category extends Component {
  ...
  peticionPost = async () => {
    ...
    await axios
      .post(urlPost, this.state.form, header)
      .then((response) => {
        this.modalInsertar();
        this.peticionGet();
      })
  ...
  peticionPut = () => {
    axios
      .put(urlPut + this.state.form.id, this.state.form, header)
      .then((response) => {
        this.modalInsertar();
        this.peticionGet();
      });
    ...
    return (
      <div className="App">
                ...
                <tr>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => {
                        this.seleccionarCategoria(category);
                        this.modalInsertar();
                      }}
                    >
        ...
        <Modal isOpen={this.state.modalEliminar}>
          <ModalBody>
            Estás seguro que deseas eliminar este categoria{" "}
            {form && form.nombre}
          </ModalBody>
          <ModalFooter>
            <button
